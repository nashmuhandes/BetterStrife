...
- Applies sprite billboarding for actors that, in my opinion, would benefit from it due to their visual identity: explosions and effects sprites, gibs and metal junk, alarm sprites, ceiling turrets, stalkers, sentinels, the alien spectres, item pickups.
- Merchants' max health lowered to the same amount as the peasants. This is only cosmetic, and mainly for immersion purposes. When Strife is played with an HP bar mod (without this change, merchants will be reported as having a ridiculously high amount of hit points). They are still unkillable, however.
